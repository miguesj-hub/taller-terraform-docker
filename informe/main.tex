...
\vspace{0.4cm}
{\large Jumandi Andrade\par}
\vspace{0.4cm}
{\large Klever Guamushig\par}
\vspace{0.4cm}
{\large Guillermo Vallejo\par}
\vspace{1.2cm}
...
{\today\par}
\vspace{0.6cm}
{\small\url{https://github.com/miguesj-hub/taller-terraform-docker}\par}
...
El código completo del taller, junto con este informe, está disponible en
el repositorio
\url{https://github.com/miguesj-hub/taller-terraform-docker}.
